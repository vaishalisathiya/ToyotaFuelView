              ...
              child: Container(
                ...
                child: ElevatedButton(
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) => SVAModel(bg: bg)),
                    );
                  },
...
class SVAModel extends StatelessWidget {
  final String bg;
  final String button = '/Users/vaishalisathiya/Documents/vs code/toyota_fuel_view/toyota_fuel_view/lib/pictures/button.png';

  const SVAModel({required this.bg});
              ...
              child: Container(
                ...
                child: ElevatedButton(
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) => SVAYear(bg: bg)),
                    );
                  },
                  style: ElevatedButton.styleFrom(
                    padding: EdgeInsets.zero,
...
class SVAYear extends StatelessWidget {
  final String bg;
  final String button = '/Users/vaishalisathiya/Documents/vs code/toyota_fuel_view/toyota_fuel_view/lib/pictures/button.png';

  const SVAYear({required this.bg});
              ...
              child: Container(
                ...
                child: ElevatedButton(
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) => SVAFinal(bg: bg)),
                    );
                  },
                  style: ElevatedButton.styleFrom(
                    padding: EdgeInsets.zero,
...
class SVAFinal extends StatelessWidget {
  final String bg;  // The background image file path
  final String svanalysis = '/Users/vaishalisathiya/Documents/vs code/toyota_fuel_view/toyota_fuel_view/lib/pictures/sva.png';

  SVAFinal({required this.bg});  // Constructor to pass the background path
    ...
    return Scaffold(
      body: Stack(
        children: [
          ...
          Positioned.fill(
            child: Image.file(
              File(svanalysis), // Update this path to your image
              fit: BoxFit.cover,
            ),
          ),
